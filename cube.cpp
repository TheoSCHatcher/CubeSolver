...
void printCubeNet(CubeState& state){
    ...
    std::cout <<   cornerColours[stateCorners[2]][mod1(sCO[2]+2,3)] << "  " << edgeColours[stateEdges[2]][mod1(sEO[2]+1,2)] << "  " << cornerColours[stateCorners[3]][mod1(sCO[3]+1,3)] << " | " \
                << cornerColours[stateCorners[3]][mod1(sCO[3]+2,3)] << "  " << edgeColours[stateEdges[1]][mod1(sEO[1]+1,2)] << "  " << cornerColours[stateCorners[0]][mod1(sCO[0]+1,3)] << " | " \
                << cornerColours[stateCorners[0]][mod1(sCO[0]+2,3)] << "  " << edgeColours[stateEdges[0]][mod1(sEO[0]+1,2)] << "  " << cornerColours[stateCorners[1]][mod1(sCO[1]+1,3)] << " | " \
                << cornerColours[stateCorners[1]][mod1(sCO[1]+2,3)] << "  " << edgeColours[stateEdges[3]][mod1(sEO[3]+1,2)] << "  " << cornerColours[stateCorners[2]][mod1(sCO[2]+1,3)] << "\n";
    ...
    std::cout <<   edgeColours[stateEdges[11]][mod1(sEO[11]+1,2)]   << "  O  " << edgeColours[stateEdges[9]][mod1(sEO[9]+1,2)]      << " | " \
                ...
                << edgeColours[stateEdges[8]][mod1(sEO[8]+1,2)]     << "  R  " << edgeColours[stateEdges[10]][mod1(sEO[10]+1,2)]    << " | " \
                << edgeColours[stateEdges[10]][sEO[10]]             << "  B  " << edgeColours[stateEdges[11]][sEO[11]]              << "\n";

    std::cout <<   cornerColours[stateCorners[6]][mod1(sCO[6]+1,3)] << "  " << edgeColours[stateEdges[6]][mod1(sEO[6]+1,2)] << "  " << cornerColours[stateCorners[7]][mod1(sCO[7]+2,3)] << " | " \
                << cornerColours[stateCorners[7]][mod1(sCO[7]+1,3)] << "  " << edgeColours[stateEdges[5]][mod1(sEO[5]+1,2)] << "  " << cornerColours[stateCorners[4]][mod1(sCO[4]+2,3)] << " | " \
                << cornerColours[stateCorners[4]][mod1(sCO[4]+1,3)] << "  " << edgeColours[stateEdges[4]][mod1(sEO[4]+1,2)] << "  " << cornerColours[stateCorners[5]][mod1(sCO[5]+2,3)] << " | " \
                << cornerColours[stateCorners[5]][mod1(sCO[5]+1,3)] << "  " << edgeColours[stateEdges[7]][mod1(sEO[7]+1,2)] << "  " << cornerColours[stateCorners[6]][mod1(sCO[6]+2,3)] << "\n";
